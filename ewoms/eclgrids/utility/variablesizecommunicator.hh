...
/*
*/
#ifndef EWOMS_COMMON_PARALLEL_VARIABLESIZECOMMUNICATOR_HH // Still fits the line!
#define EWOMS_COMMON_PARALLEL_VARIABLESIZECOMMUNICATOR_HH
...
private:
   ...
   */
  template<bool FORWARD, class DataHandle>
  [[maybe_unused]] void communicateFixedSize(DataHandle& handle);
   /**
 ...
 */
 inline void sendFixedSize(std::vector<InterfaceTracker>& send_trackers,
...
inline bool validRecvRequests(const std::vector<MPI_Request> reqs)
{
