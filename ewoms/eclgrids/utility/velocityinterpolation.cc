...
*/
#include "config.h"
#include <ewoms/eclgrids/utility/velocityinterpolation.hh>
#include <ewoms/eclgrids/unstructuredgrid.h>
#include <ewoms/eclio/utility/numeric/blas_lapack.h>
        ...
        for (int cell = 0; cell < num_cells; ++cell) {
            ...
            for (int cell_corner = 0; cell_corner < num_cell_corners; ++cell_corner) {
                ...
                if (info != 0) {
                    ...
                    EWOMS_THROW(std::runtime_error, "Lapack error: " << info << " encountered in cell " << cell);
                }
