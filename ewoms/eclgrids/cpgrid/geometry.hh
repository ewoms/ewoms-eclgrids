...
#ifndef EWOMS_GEOMETRY_HEADER
#define EWOMS_GEOMETRY_HEADER
...
namespace Dune
{
    namespace cpgrid
    {
        ...
        public:
            ...
            const GlobalCoordinate& global(const LocalCoordinate&) const
            {
                EWOMS_THROW(std::runtime_error, "Geometry::global() meaningless on singular geometry.");
            }

            /// This method is meaningless for singular geometries.
            LocalCoordinate local(const GlobalCoordinate&) const
            {
                EWOMS_THROW(std::runtime_error, "Geometry::local() meaningless on singular geometry.");
            }
            ...
            jacobianTransposed(const LocalCoordinate& /* local */) const
            {
                EWOMS_THROW(std::runtime_error, "Meaningless to call jacobianTransposed() on singular geometries.");
            }
            ...
            jacobianInverseTransposed(const LocalCoordinate& /*local*/) const
            {
                EWOMS_THROW(std::runtime_error, "Meaningless to call jacobianInverseTransposed() on singular geometries.");
            }
