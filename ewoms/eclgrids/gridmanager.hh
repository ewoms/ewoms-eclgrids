...
#ifndef EWOMS_ECLGRIDSMANAGER_HH
#define EWOMS_ECLGRIDSMANAGER_HH
...
namespace Ewoms
{
    /// This class manages an Ewoms::UnstructuredGrid in the sense that it
    ...
    public:
        ...
        explicit GridManager(const Ewoms::EclipseGrid& inputGrid);
        ...
        GridManager(const Ewoms::EclipseGrid& inputGrid,
    ...
    private:
        ...
        void initFromEclipseGrid(const Ewoms::EclipseGrid& inputGrid,
                                 const std::vector<double>& poreVolumes);
#endif
...
#endif // EWOMS_ECLGRIDSMANAGER_HH
