...
#include <ewoms/eclgrids/polyhedralgrid/entity.hh>
#include <ewoms/eclgrids/polyhedralgrid/entityseed.hh>
#include <ewoms/eclgrids/polyhedralgrid/geometry.hh>
#include <ewoms/eclgrids/polyhedralgrid/gridview.hh>
#include <ewoms/eclgrids/polyhedralgrid/idset.hh>
...
namespace Dune
{
  ...
  public:
    ...
    /** \brief constructor
     *
     *  \param[in]  deck         Eclipse deck
     *  \param[in]  poreVolumes  vector with pore volumes (default = empty)
     */
    explicit PolyhedralGrid ( const Ewoms::EclipseGrid& inputGrid,
    ...
    */
    ...
    void communicate ( DataHandle& /* dataHandle */,
                       ...
                       int /* level */ ) const
    {
        EWOMS_THROW(std::runtime_error, "communicate not implemented for polyhedreal grid!");
    }
    ...
    {
        EWOMS_THROW(std::runtime_error, "switch to global view not implemented for polyhedreal grid!");
    }

    /// \brief Switch to the distributed view.
    void switchToDistributedView()
    {
        EWOMS_THROW(std::runtime_error, "switch to distributed view not implemented for polyhedreal grid!");
    }
    ...
    {
        EWOMS_THROW(std::runtime_error, "ScatterData not implemented for polyhedral grid!");
    }

  protected:
#if HAVE_ECL_INPUT
    UnstructuredGridType* createGrid( const Ewoms::EclipseGrid& inputGrid, const std::vector< double >& poreVolumes ) const
    {
        struct grdecl g;
        ...
        if (!poreVolumes.empty() && (inputGrid.getMinpvMode() != Ewoms::MinpvMode::ModeEnum::Inactive))
        {
          Ewoms::MinpvProcessor mp(g.dims[0], g.dims[1], g.dims[2]);
          ...
          //bool opmfil = inputGrid.getMinpvMode() == Ewoms::MinpvMode::OpmFIL;
          bool opmfil = true;
        ...
        */
        ...
        if (!cgrid) {
            EWOMS_THROW(std::runtime_error, "Failed to construct grid.");
        }
        return cgrid;
    }
#endif
...
#include <ewoms/eclgrids/polyhedralgrid/persistentcontainer.hh>
#include <ewoms/eclgrids/polyhedralgrid/cartesianindexmapper.hh>
#include <ewoms/eclgrids/polyhedralgrid/gridhelpers.hh>
